...
#SBATCH -J 3dfa_mesa_dense
#SBATCH -o 3dfa_mesa_dense_%j.out
#SBATCH -e 3dfa_mesa_dense_%j.err
...
export WANDB_DIR=$SCRATCH_BASE/tmp/wandb/3dfa_mesa_dense
...
source scripts/mesa/train_mesa_dense.sh
